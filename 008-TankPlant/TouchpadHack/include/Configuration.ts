export type CodeTypes = 'Touch Pads';
...
export const CODES: Record<CodeTypes, CodeInfo> = {
    touchpads: {
        ...
        constexpr uint16_t MIN_PARK_TIME = 10, MAX_PARK_TIME = 20; // minimum and maximum park times in seconds
         ...
         */
        inline int16_t HEADINGS_IN_MAP[5] = {-90, -45, 0, 45, 90};    // independent variable for the piecewise functions
        inline int16_t LEFT_SPEED_MAP[5] = {-255, 0, 150, 192, 255};  // dependent variable for piecewise linear function for left motor (ex: when heading is 45, lMotor speed is 192)
        inline int16_t RIGHT_SPEED_MAP[5] = {255, 192, 150, 0, -255}; // dependent variable for piecewise linear function for right motor speed (ex: when heading is 45, rMotor speed is 0)
        ...
        */
        ...
        constexpr int16_t TOUCH_THRESHOLD = 100;        // readings above this value will be considered an active touch. This may need tuning for each unique sensor pad.
