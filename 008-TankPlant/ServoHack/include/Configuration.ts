...
export const CODES: Record<CodeTypes, CodeInfo> = {
    standard: {
              ...
              },
              {
                ...
                validation: (value) => {
                  ...
                  if (num < 0 || num > 180) {           
                    return {
                      valid: false,
                      message: 'Value must be between 0 and 180',
                    };
                  }
                  return { valid: true, message: '' };
                },
        ...
        */
        ...
        uint8_t flagServoPos = FLAG_RAISED_POS;     // servo position tracking variable
        float flagWaveSpeed = 40.0;                 // wave speed in degrees per second
